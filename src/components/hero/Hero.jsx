...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Navbar */}
      <header className="relative z-20 flex items-center justify-between px-6 md:px-12 py-5 text-white hero-nav">
      ...
      <main className="relative z-20 flex items-center justify-center min-h-[80vh] px-6">
        <div className="max-w-4xl text-center hero-fade">
          <h1
            className="hero-title text-white font-extrabold leading-tight tracking-tight
            text-4xl sm:text-5xl md:text-7xl lg:text-7xl"
          >
            Start something  epic.
          </h1>

          <p className="hero-text mt-6 text-white/90 text-sm md:text-base max-w-xl mx-auto">
          ...
          <Link
            to="/signup"
            className="hero-btn inline-block mt-10 rounded-full px-12 py-4 text-sm md:text-base  hero-fade
      ...
      {/* Disclaimer */}
      <p className="absolute bottom-4 right-6 text-xs text-white/60 z-20 hero-text">
