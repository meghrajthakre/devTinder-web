...
const ProfileSidebar = ({
  ...
  return (
    <div className="bg-base-100 rounded-xl border border-base-300 shadow-sm p-5 space-y-5 h-fit">
      {/* Avatar + Identity */}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="border border-base-300 rounded-lg p-3 hover:border-primary transition">
          <p className="text-lg font-bold text-primary">
            {user.skills?.length || 0}
          </p>
          <p className="text-xs uppercase tracking-wide opacity-60">Skills</p>
        </div>
        ...
        <div className="border border-base-300 rounded-lg p-3 hover:border-primary transition">
          ...
          <p className="text-xs uppercase tracking-wide opacity-60">Stack</p>
        </div>
      </div>
