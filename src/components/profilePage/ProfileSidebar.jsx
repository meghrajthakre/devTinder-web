      ...
      <div className="flex items-center gap-4 justify-between">
        <div className="flex items-center gap-4">
          <div
            ...
            className="relative w-24 h-24 rounded-full overflow-hidden ring-2 ring-primary/70 cursor-pointer group"
          >
            <img src={photo} className="w-full h-full object-cover p-1 rounded-full" />
